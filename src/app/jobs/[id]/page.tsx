            ...
            <main className="flex-1 max-w-4xl mx-auto w-full p-6 my-8">
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                    <div className="p-8 md:p-10">
                        <div className="mb-6">
                            <span className="inline-block bg-blue-100 text-[#0e4ecf] text-sm px-3 py-1 rounded-full font-bold mb-4">
                                {job.location}
                            </span>
                        ...
                        <div className="mt-12 pt-8 border-t border-gray-100">
                            <div className="flex flex-col md:flex-row items-center justify-between gap-6 p-6 bg-[#f8fbff] rounded-xl border border-blue-100">
                                <div>
                                    <h4 className="text-lg font-bold text-[#0e4ecf] mb-1">이 직무에 관심이 있으신가요?</h4>
